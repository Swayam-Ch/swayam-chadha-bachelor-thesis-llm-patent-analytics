...
mockup_100.py
=============
Runs the extended annotation schema (v5) on a stratified 100-patent sample.
Outputs:
  - mockup_100_results.csv      : full results for all 100 patents
  - mockup_100_professor_sample.csv : 10-patent sample for professor review
                                     (diverse across years, techniques, orientations)

Usage:
  pip install openai pandas requests
  export OPENAI_API_KEY="sk-..."
  export LENS_API_KEY="your-lens-key"          # only needed if lens_500_combined.csv not present
  python mockup_100.py
"""
